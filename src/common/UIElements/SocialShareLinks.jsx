  ...
  return (
    <>
      <SocialShareIcon
        ...
        href={`https://twitter.com/intent/tweet?url=https://web30.my.id/${slug}&text="${title}"%20by%20@Web3IDN`}
        icon={<FaTwitter />}
      />
      <SocialShareIcon
        label={'Share on LinkedIn'}
        placement={toolTipPlacement}
        href={`https://www.linkedin.com/shareArticle?mini=true&url=https://web30.my.id/${slug}`}
        icon={<FaLinkedin />}
      />
      <SocialShareIcon
        label={'Share on Facebook'}
        placement={toolTipPlacement}
        href={`https://www.facebook.com/sharer/sharer.php?u=https://web30.my.id/${slug}`}
        icon={<FaFacebook />}
      />
      <SocialShareIcon
        label={'Share on Reddit'}
        placement={toolTipPlacement}
        href={`https://reddit.com/submit?url=https://web30.my.id/${slug}&title=${title}`}
        icon={<FaReddit />}
      />
